      ...
      <div className="w-9/10 mx-auto flex flex-col gap-10">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {title && (
            <div className="w-full flex md:justify-center">
              <h2 className="title-teal text-left md:text-center">{title}</h2>
            </div>
          )}
          {text && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
          {items.map((it, idx) => (
            <article
              key={idx}
              className="rounded-2xl shadow-lg flex flex-col bg-white border-2 transition h-full border-[#1C86D1]/60"
            >
              {it.image && (
                <div
                  className={[
              ...
              <div className="flex flex-col gap-4 flex-1 md:pt-6 md:pb-6 md:px-5 p-5">
