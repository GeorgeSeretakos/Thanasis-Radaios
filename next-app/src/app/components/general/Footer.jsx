          ...
          <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
            ...
            {isHome ? (
              <>
                {/* Title */}
                <h1
                  className="text-center text-[22px] sm:text-[24px] md:text-[25px] font-semibold tracking-[0.14em] uppercase leading-none">
                  Τεχνικό Γραφείο
                </h1>
                ...
                <div className="mt-4 mx-auto max-w-4xl text-left">
                  <div
                    className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-xs md:text-sm leading-snug">
                    {/* Phones */}
