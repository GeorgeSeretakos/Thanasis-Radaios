...
import PresentationGrid from "@/app/components/PresentationGrid";
  ...
  return (
      <main>
          ...
          <PresentationGrid
              ...
              text="Επιλέξτε ανάμεσα στο ενσύρματο i-body® και στο ασύρματο i-body® wireless (με in-door & outdoor εκδόσεις). Με την απόκτηση ενός συστήματος Miha Bodytec, δεν αγοράζετε απλώς εξοπλισμό, αλλά ένα πλήρες πακέτο: εκπαίδευση, τεχνική υποστήριξη και επιχειρηματική καθοδήγηση."
              ctaLink="/office"
