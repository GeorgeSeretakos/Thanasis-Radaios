          ...
          <>
            ...
            <div className="mt-6 space-y-3 leading-relaxed">
              ...
              <p className="flex items-center gap-2">
                ...
                />
                <i>
                  <strong className="text-xl">Και το καλύτερο;</strong> Μαζί με το σύστημα, στην τιμή περιλαμβάνεται ολόκληρο το πακέτο συνεργασίας με όλα τα παρακάτω προνόμια.
                </i>
              </p>
